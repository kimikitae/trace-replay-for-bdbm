...
extern gsize interval_read_ftl_global;
extern gsize interval_read_dev_global;
extern gsize interval_write_ftl_global;
extern gsize interval_write_dev_global;

extern int idx_map;

void modify_read_ftl_global(unsigned long val);
void modify_read_dev_global(unsigned long val);
void modify_write_ftl_global(unsigned long val);
void modify_write_dev_global(unsigned long val);

void set_idx_map(int i);
