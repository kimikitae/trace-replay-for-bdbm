...
extern gsize interval_read_bdm_global;
extern gsize interval_write_bdm_global;
extern gsize interval_bdm_global;

void modify_read_bdm_global(unsigned long val);
void modify_write_bdm_global(unsigned long val);
void modify_bdm_global(unsigned long val);
