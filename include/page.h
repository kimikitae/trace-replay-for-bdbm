...
/* page-map.c */
struct device_address page_ftl_get_free_page(struct page_ftl *, size_t sector);
int page_ftl_update_map(struct page_ftl *, size_t sector, uint32_t ppn);

struct device_address page_ftl_get_mapping_table(struct page_ftl *, size_t sector);
